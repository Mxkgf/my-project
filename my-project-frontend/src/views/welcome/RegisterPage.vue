...
const rule = {
  ...
  password: [
    ...
    {min: 6, max: 20, message: '密码长度必须在6-16个字符之间', trigger: ['blur', 'change']}
  ],
  password_repeat: [
...
<template>
  <div style="text-align: center; margin: 0 20px">
    <div style="margin-top: 100px">
      ...
      <div style="font-size: 14px; color: grey">欢迎注册，请填写相关信息</div>
    </div>
    <div style="margin-top: 50px">
      <el-form :model="form" :rules="rule" ref="formRef">
        ...
        <el-form-item style="margin-top: 20px" prop="email">
          <el-input v-model="form.email" maxlength="20" type="email" placeholder="电子邮件地址">
            <template #prefix>
        ...
        <el-form-item style="margin-top: 20px" prop="code">
          <el-row style="width: 100%;" gutter="10">
            ...
            <el-col :span="5">
              <el-button :disabled="!isEmailValid || coldTime" type="success" @click="askCode">
      ...
      <div style="margin-top: 20px">
        ...
        <el-link @click="router.push('/')" style="translate: 0 -1px">立即登录</el-link>
      </div>
    </div>
  </div>
</template>
